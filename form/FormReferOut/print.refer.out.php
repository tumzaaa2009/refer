...
$templateProcessor->setValue('dia-org', $_POST['digonosis']);
...
$templateProcessor->setValue('management', $_POST['managementDes']);
$templateProcessor->setValue('causeReferoutDes', $_POST['causeReferoutDes']);
...
$templateProcessor->setValue('nextpage', 'การประเมินผู้ป่วยระหว่างส่งต่อ');
$templateProcessor->setValue('lastNamefullNameLastName', $_POST['fname']);
$templateProcessor->setValue('cid', $_POST['cid']);
$templateProcessor->setValue('sex', $_POST['gender']);
$templateProcessor->setValue('age', $_POST['age']);
$templateProcessor->setValue('truma',$_POST['TypeptDes']);
$templateProcessor->setValue('level', $_POST['lvAcityDes']);
$templateProcessor->setValue('contractis', $_POST['coordinateIs']);
$templateProcessor->setValue('level', $_POST['lvAcityDes']);
$templateProcessor->setValue('sendRefer', $_POST['loadsDes']);
