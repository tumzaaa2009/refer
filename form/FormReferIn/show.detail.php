 <form enctype="multipart/form-data" id="refer-in-form">
     <div class="card-body">
             ...
             <div class="card ">
                 <div class="card-header   p-2">
                     <ul class="nav nav-pills">
                         ...
                         <li class="nav-item"><a class="nav-link" href="#tabDrugs" data-toggle="tab">ข้อมูลการใช้ยา</a>
                         </li>
                     </ul>
                 </div><!-- /.card-header -->
                 <div class="card-body">
                                     ...
                                     <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                                         ...
                                         <div class="form-group row">
                                                     ...
                                                     <div class="form-group ">
                                                         <div class="row">
                                                             ...
                                                             <div class="col-md-auto col-lg-auto">
                                                                 ...
                                                                 <div class="col-md-auto">
                                                                     <textarea style="width: 450px;" title="Contents" name="managementDes" id="managementDes"></textarea>
                                                                 </div>
                                                             </div>
                                                             <div class="col-md-auto col-lg-auto">
                                                                 <div align="left">
                                                                 ...
                                                                 <div class="col-md-auto">
                                                                     <textarea name="digonosis" style="width: 450px;" id="Diagonosis" title="Diagonosis"></textarea>
                                                                 </div>
                                                                 <div class="col-md-auto">
                                                                     <label>Diagonosis ปลายทาง</label>
                                                                 </div>
                                                                 <div class="col-md-auto">
                                                                     <textarea name="digonosisDes" id="DiagonosisDes" style="width: 450px;"></textarea>
                                                                 </div>
                                                             </div>
                                                     ...
                                                     <div class="form-group ">
                                                         <div class="row">
                                                             ...
                                                             <div class="col-md-auto col-lg-auto">
                                                                 ...
                                                                 <div class="col-md-auto">
                                                                     <textarea name="ccDestination" style="width: 450px;" id="ccDestination" title="Contents">ccDestination</textarea>
                                                                 </div>
                                                             </div>
                                                         </div>
                                                     </div>
                                             ...
                                             <div align="right">
                                                 ...
                                                 <button type="button" id="UpStatusReferOutDes" class="btn btn-success btn-lg" onclick="UpStatusReferOutIsSave()">รับ Refer</button>


                                             </div>
                                             <div align="right"><button type="button" id="UpStatusReferOutDesResive" class="btn btn-success btn-lg" onclick="SendReferIn()">ส่งตัวกลับ</button>
                                                 <div align="right"> <span id="referSus"></span> </div>
